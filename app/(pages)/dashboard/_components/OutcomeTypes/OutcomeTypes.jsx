        ...
        <div>
          ...
          />
            <div className={styles.typeItem}>
              ...
              <p className={styles.percentage}>{`${Math.round(parseFloat(outcomeData.percentages.food))}%`}</p>
          </div>  
          <div className={styles.typeList}>
            <Image
                src={AcademicsIcon}
            ...
            <div className={styles.typeItem}>
              ...
              <p className={styles.percentage}>{`${Math.round(parseFloat(outcomeData.percentages.academics))}%`}</p>
          </div> 
          <div className={styles.typeList}>
            <Image
            ...
            <div className={styles.typeItem}> 
                ...
                <p className={styles.percentage}>{`${Math.round(parseFloat(outcomeData.percentages["personal care"]))}%`}</p>
          </div> 
          <div className={styles.typeList}>
            <Image
                src={HousingIcon}
            ...
            <div className={styles.typeItem}>
              ...
              <p className={styles.percentage}>{`${Math.round(parseFloat(outcomeData.percentages.housing))}%`}</p>
          </div> 
          <div className={styles.typeList}>
            <Image
                src={TravelIcon}
            ...
            <div className={styles.typeItem}>
              ...
              <p className={styles.percentage}>{`${Math.round(parseFloat(outcomeData.percentages.travel))}%`}</p>
          </div> 
          <div className={styles.typeList}>
            <Image
                src={MiscIcon}
            ...
            <p className={styles.percentage}>{`${Math.round(parseFloat(outcomeData.percentages.misc))}%`}</p>
            </div> 
          </div>
      )}
    </div>
